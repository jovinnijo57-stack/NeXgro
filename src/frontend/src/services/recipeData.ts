...
export const STATIC_RECIPES: Record<string, any> = {
  "IDLI": {
    water: "2 cups (for steaming) + 1.25 cups (for grinding)",
    time: "12 minutes (steaming) + fermentation",
    steps: [
  ...
  "DOSA": {
    water: "Varies for batter consistency",
    time: "2 minutes per dosa + fermentation",
    steps: [
  ...
  "POHA": {
    water: "Rinsing only + 2 min steam",
    time: "10 minutes",
    steps: [
  ...
  "SMOOTHIE BOWL": {
    water: "None (uses 1/4 cup almond milk)",
    time: "5 minutes",
    steps: [
